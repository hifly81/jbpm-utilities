...
public class TasksByGroupsAndVariablesAndParamsFilter implements QueryParamBuilder<ColumnFilter> {

    private static final Logger LOG = LoggerFactory.getLogger(TasksByGroupsAndVariablesAndParamsFilter.class);

    private Map<String, Object> parameters;
    private boolean built = false;

    public TasksByGroupsAndVariablesAndParamsFilter(Map<String, Object> parameters) {
