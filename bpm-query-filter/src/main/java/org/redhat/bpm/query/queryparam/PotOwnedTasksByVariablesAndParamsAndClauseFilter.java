...
public class PotOwnedTasksByVariablesAndParamsAndClauseFilter implements QueryParamBuilder<ColumnFilter> {

    private static final Logger LOG = LoggerFactory.getLogger(PotOwnedTasksByVariablesAndParamsAndClauseFilter.class);

    private Map<String, Object> parameters;
    private boolean built = false;

    public PotOwnedTasksByVariablesAndParamsAndClauseFilter(Map<String, Object> parameters) {
    ...
    public ColumnFilter build() {
        ...
        ColumnFilter potOwnerFilter = AND(
            OR(equalsTo("actualOwner", user), equalsTo("actualOwner", ""), isNull("actualOwner")),
    ...
    private ColumnFilter buildMapFilter(Map<String, List<String>> map, String name, String value) {
        ...
        return AND(map.entrySet().stream()
