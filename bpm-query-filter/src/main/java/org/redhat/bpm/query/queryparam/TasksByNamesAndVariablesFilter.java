...
public class TasksByNamesAndVariablesFilter implements QueryParamBuilder<ColumnFilter> {

    private static final Logger LOG = LoggerFactory.getLogger(TasksByNamesAndVariablesFilter.class);

    private Map<String, Object> parameters;
    private boolean built = false;

    public TasksByNamesAndVariablesFilter(Map<String, Object> parameters) {
    ...
    public ColumnFilter build() {
        ...
        ColumnFilter filter = AND(in("tvname", names));
