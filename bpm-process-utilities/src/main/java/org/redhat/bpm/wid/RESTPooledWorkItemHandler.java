...
/**
 * IMPORTANT!!!!!!
 * This is a backporting of the Rest WID in BPM 7.x to BPM 6.x.
 * The support for this class is available only contacting Red Hat Italy professional services.
 *
 * For the original implementation in jbpm project see:
 ...
 * </ul>
 */
public class RESTPooledWorkItemHandler extends AbstractLogOrThrowWorkItemHandler implements Cacheable {

    private static final Logger logger = LoggerFactory.getLogger(RESTPooledWorkItemHandler.class);
     ...
     */
    public RESTPooledWorkItemHandler(boolean doCacheClient,
    ...
    public RESTPooledWorkItemHandler(boolean doCacheClient,
                                     ...
                                     String username,
                                     String password) {
        this(doCacheClient, totalPoolConnections, maxPoolConnectionsPerRoute);
    ...
    public RESTPooledWorkItemHandler(boolean doCacheClient,
                                     ...
                                     String password,
                                     String authUrl) {
        this(doCacheClient, totalPoolConnections, maxPoolConnectionsPerRoute, username, password);
